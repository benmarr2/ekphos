...
pub struct BaseViewState {
    pub(crate) compiled: Option<crate::bases::CompiledBase>,
    pub(crate) corpus: crate::bases::Corpus,
    pub result: Option<crate::bases::BaseResult>,
...
pub struct CanvasViewState {
    pub document: Option<crate::canvas::Canvas>,
    ...
    pub handle_rects: Vec<(crate::canvas::CanvasSide, Rect)>,
...
pub enum CanvasInteraction {
    ...
    Connecting {
        from_node: usize,
        from_side: Option<crate::canvas::CanvasSide>,
...
pub struct VaultState {
    pub(crate) inner: crate::vault::Vault,
    pub(crate) body_cache: crate::vault::BodyCache,
...
impl VaultState {
    pub(crate) fn new(inner: crate::vault::Vault, list_state: ListState) -> Self {
        Self {
            inner,
            body_cache: crate::vault::BodyCache::default(),
    ...
    pub(crate) fn replace(&mut self, vault: crate::vault::Vault) {
        self.inner = vault;
    }
}

impl Deref for VaultState {
    type Target = crate::vault::Vault;
...
pub struct DocumentState {
    ...
    pub(crate) active_fingerprint: Option<crate::vault::FileFingerprint>,
